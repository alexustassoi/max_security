...
<div class="text-repeater <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo ' space-top-type-' . do_shortcode($space_top_type) . ' '; echo ' space-bottom-type-' . $space_bottom_type . ' '; ?>" style="background-color: <?php echo $bg_color; ?>">
    <div class="custom-container">
        <?php
        if (!empty($title)) {
            echo '<div class="text-repeater__title">' . do_shortcode($title) . '</div>';
        }
        ...
        if (!empty($text_repeater)) {
            foreach ($text_repeater as $item) {
                ...
                echo '<div class="text-repeater__item js-benefts-item">
                            <div class="text-repeater__item-title js-benefts-title">
                            ...
                            ' . do_shortcode($item['title']) . '</div>
                            <div class="text-repeater__item-description js-benefts-content">
