...
<div class="courses  <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo esc_html($class_name); ?>" id="<?php echo $args['id']; ?>">
    <div class="custom-container">
        <?php if ($title) : ?>
            <h2 class="courses__title"><?php echo $title; ?></h2>
        <?php endif; ?>
    </div>
    ...
    <div class="custom-container">
        <?php if ($slides) : ?>
            <div class="swiper courses__swiper js-courses-slider">
                    ...
                    ?>
                        <div class="swiper-slide courses__slide">
                            <div class="courses__slide-wrap">
                                ...
                                <div class="courses__slide-inner">
                                    <?php if (!empty($item['date'])) : ?>
                                        <p class="courses__slide-date"><?php echo $item['date']; ?></p>
                                    <?php endif; ?>

                                    <?php if (!empty($item['title'])) : ?>
                                        <div class="courses__slide-title">
                                            <?php echo do_shortcode($item['title']); ?></p>
                                        </div>
                                    <?php endif; ?>

                                    <?php if (!empty($item['subtitle'])) : ?>
                                        <div class="courses__slide-subtitle">
                                            <?php echo do_shortcode($item['subtitle']); ?></p>
                                        </div>
                                    <?php endif; ?>
                ...
                <div class="courses__button prev js-prev-courses">
                ...
                <div class="courses__button next js-next-courses">
                    <svg xmlns="http://www.w3.org/2000/svg" width="52" height="53" viewBox="0 0 52 53" fill="none">
