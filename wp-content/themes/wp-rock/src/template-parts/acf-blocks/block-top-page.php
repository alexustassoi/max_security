...
<div class="top-page js-top-block <?php echo esc_html($class_name); ?>" id="<?php echo $args['id']; ?>">
    <div class="top-page__wrap">
        ...
        <?php if($video): ?>
            <video class="js-top-page-video  top-page__video" autoplay muted loop playsinline>
