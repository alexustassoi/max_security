...
$benefts           = get_field_value( $fields, 'benefts' );

$pt_space_class = wp_rock_block_space_class($block_pt, 'block_pt');
$pb_space_class = wp_rock_block_space_class($block_pb, 'block_pb');
?>

<div class="benefts <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo esc_html($class_name); echo ' space-top-type-' . do_shortcode($space_top_type) . ' '; echo ' space-bottom-type-' . $space_bottom_type . ' '; ?>" id="<?php echo $args['id']; ?>">
    <div class="custom-container">
        <?php if($title): ?>
            <div class="benefts__title"><?php echo $title; ?></div>
        <?php endif; ?>

        <?php if($benefts): ?>
            <div class="benefts__wrap">
                <?php foreach ($benefts as $item):
                    $benefts_title = $item['title'];
                    $benefts_content = $item['content'];
                ?>
                    <div class="benefts__item js-benefts-item">
                        <?php if($benefts_title): ?>
                            <div class="benefts__item-title js-benefts-title">
                                ...
                                <?php echo $benefts_title; ?>
                            </div>
                        <?php endif; ?>

                        <?php if($benefts_content): ?>
                            <div class="benefts__item-content js-benefts-content"><?php echo $benefts_content; ?></div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            </div>
