...
<div class="benefts <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo esc_html($class_name); ?>" id="<?php echo $args['id']; ?>">
                ...
                ?>
                    <div class="benefts__item js-benefts-item">
                        <?php if($benefts_title): ?>
                            <h5 class="benefts__item-title js-benefts-title">
                        ...
                        <?php if($benefts_content): ?>
                            <p class="benefts__item-content js-benefts-content"><?php echo $benefts_content; ?></p>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            </div>
