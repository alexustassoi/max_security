...
<div class="experts <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo esc_html($class_name); echo ' space-top-type-' . do_shortcode($space_top_type) . ' '; echo ' space-bottom-type-' . $space_bottom_type . ' '; ?>" id="<?php echo $args['id']; ?>"
    ...
    <div class="custom-container">
        ...
        <?php if ($experts): ?>
            <div class="swiper experts__swiper js-experts-slider">
                <div class="swiper-wrapper">
                    <?php foreach ($experts as $expert):
                        $avatar = $expert['avatar'];
                        $name = $expert['name'];
                        $position = $expert['position'];
                        $direction_icon = $expert['direction_icon'];
                        $direction = $expert['direction'];
                        $description = $expert['description'];
                        $date = $expert['date'];
                        $work_example = $expert['work_example'];
                        $link = $expert['link'];
                        ?>
                        <div class="swiper-slide experts__slide">
                            <div class="experts__slide-left">
                                <div class="experts__slide-avatar">
                                    <?php if($avatar): ?>
                            ...
                            <div class="experts__slide-right">
                                <div class="experts__slide-direction-wrap">
                                    <?php if($direction_icon): ?>
                                        <img src="<?php echo $direction_icon; ?>" alt="icon">
                                    <?php endif; ?>
                ...
                <div class="experts__button prev js-prev-expert">
                ...
                <div class="experts__button next js-next-expert">
                    <svg xmlns="http://www.w3.org/2000/svg" width="52" height="53" viewBox="0 0 52 53" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
