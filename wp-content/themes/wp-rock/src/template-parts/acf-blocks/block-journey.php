...
$bg_color_reviews_slides = get_field_value($fields, 'bg_color_reviews_slides');
...
if (!$hide_block) : ?>
    ...
    <div class="journey  <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ' ';
    ...
    echo 'space-bottom-type-' . $space_bottom_type . ' '; ?>" id="<?php echo $args['id']; ?>">
        ...
        if ($reviews): ?>
            <div class="custom-container reviews">
                <div class="swiper reviews__swiper js-reviews-slider">
                    <div class="swiper-wrapper">
                        <?php foreach ($reviews as $item):
                            ...
                            <div class="swiper-slide reviews__slide">
                                <div class="reviews__slide-wrap">
                                    ...
                                    <div class="reviews__slide-content" style="background-color: <?php echo $bg_color_reviews_slides ?: '#FFF'?>;">
                                        <?php if ($item_review): ?>
                    ...
                    <div class="reviews__button prev js-prev-reviews">
                    ...
                    <div class="reviews__button next js-next-reviews">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="53" viewBox="0 0 52 53" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
