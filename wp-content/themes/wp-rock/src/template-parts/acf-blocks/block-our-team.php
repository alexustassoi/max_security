...
?>
<div class="our-team <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo esc_html($class_name); echo ' space-top-type-' . do_shortcode($space_top_type) . ' '; echo ' space-bottom-type-' . $space_bottom_type . ' '; ?>" id="our-team">
    <div class="our-team__custom-container">
        <?php
        if (!empty($title)) {
            echo '<div class="our-team__title">' . do_shortcode($title) . '</div>';
        }
        if (!empty($subtitle)) {
            echo '<div class="our-team__subtitle">' . do_shortcode($subtitle) . '</div>';
        }
        if (!empty($description)) {
            echo '<div class="our-team__description">' . do_shortcode($description) . '</div>';
        }
        ?>
