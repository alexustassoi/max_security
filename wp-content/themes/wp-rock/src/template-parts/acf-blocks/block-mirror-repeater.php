        ...
        <?php if (!empty($mirror_items)) : ?>
            <div class="mirror-repeater__container">
                <?php foreach ($mirror_items as $key => $item) :
                    ...
                    $connected_course = $item['connected_course_for_modal_window'];
                ...
                ?>
                    <div class="mirror-repeater__item js-mirror-item
                        ...
                        <div class="mirror-repeater__item-inner">
                            ...
                            if ($connected_course) {
                                echo ' <a href="#connected-course-popup"
                                          data-slide_index="' . $key . '"
                                          class="mirror-repeater__item-link js-open-slide-course-popup-link js-open-popup-activator">
                                            ' . __("Course overview", "wp-rock") . '
                                        </a>';
                            }
                            ?>
                        </div>
    ...
    <div id="connected-course-popup" class="popup course-popup js-popup-close">
        ...
        <div class="course-popup__wrapper-inner">
            <div class="custom-container course-popup__container-inner">
                <div class="course-popup__header-area">
                    <div class="course-popup__header">
                        <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M30.6949 19.5057H33.5818L35.074 21.486L43.6076 10.1815C40.6306 4.10551 34.5266 1 23.4961 1C6.1516 1 1 8.67378 1 23.5038C1 36.2559 4.8093 43.7197 16.9047 45.5575L33.6268 23.3988L30.6949 19.5132V19.5057ZM17.7296 27.4945H15.3151V23.3763L12.8555 26.7368L10.3959 23.3763V27.4945H7.98132V19.4757H10.0958L12.8555 23.2488L15.6149 19.4757H17.7296V27.4945ZM26.7729 27.5245L26.3231 26.4444H22.7762L22.3262 27.5245H19.7242L23.4435 19.5057H25.6706L29.3901 27.5245H26.7879H26.7729Z" fill="#231F20" />
                            <path d="M44.1479 11.3906L38.0289 19.4995H39.6337L36.6117 23.5051L39.6412 27.5183H36.7541L35.1645 25.4104L33.5747 27.5183H31.9701L18.2324 45.7239C19.8446 45.9114 21.5994 46.0013 23.504 46.0013C40.8485 46.0013 46.0001 38.3275 46.0001 23.4976C46.0001 18.7118 45.4602 14.6687 44.1554 11.3906H44.1479Z" fill="#231F20" />
                        </svg>
                    ...
                    <button class="course-popup__close js-popup-close">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M23 1.5H1V23.5H23V1.5Z" stroke="#1D1D1B" stroke-width="0.57" stroke-miterlimit="10" />
                            <path d="M4.81592 5.32422L19.5466 20.0549" stroke="#1D1D1B" stroke-width="0.57" stroke-miterlimit="10" />
                            <path d="M19.5466 5.32422L4.81592 20.0549" stroke="#1D1D1B" stroke-width="0.57" stroke-miterlimit="10" />
                        </svg>
                    </button>
                </div>
                ...
                <div class="course-popup__inner js-popup__ccs" data-slides_count="<?php echo count($slider_courses_ids); ?>">
