...
<div class="our-services <?php echo $pt_space_class ? do_shortcode($pt_space_class) . ' ' : ''; echo $pb_space_class ? do_shortcode($pb_space_class) . ' ' : ''; echo $class_name; echo ' space-top-type-' . do_shortcode($space_top_type) . ' '; echo ' space-bottom-type-' . $space_bottom_type . ' '; ?>"
        ...
        <div class="custom-container">
            ...
            echo $title
                ? '<div class="our-services__title" 
                       style="'.$color_style.'">'. do_shortcode($title) . '</div>'
                : '';
