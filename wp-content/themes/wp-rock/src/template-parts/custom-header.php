...
<div class="mobile-menu js-mobile-menu">
    ...
    <p>
        <?php if ($lets_talk_link) : ?>
            <a class="mobile-menu__talk" target="<?php echo $lets_talk_link['target']; ?>" href="<?php echo $lets_talk_link['url'] ?>"><?php echo $lets_talk_link['title']; ?></a>
        <?php endif; ?>
    </p>
