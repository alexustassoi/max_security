...
var initBlockBlogReadMore = function initBlockBlogReadMore() {
  ...
  if (blogReadMoreSwiper) {
    var blogReadMoreSlider = new Swiper(blogReadMoreSwiper, {
      spaceBetween: 42,
      slidesPerView: 3,
      loop: true,
      freeMode: true,
...
/* harmony default export */ var block_blog_read_more = ((/* unused pure expression or super */ null && (initBlockBlogReadMore)));
/******/ })()
;