...
var initBlockJourney = function initBlockJourney() {
  var mirrorItem = document.querySelectorAll('.js-mirror-item');
  var loadMoreBtn = document.querySelector('.js-load-more');
  var openCoursesSliderLinks = document.querySelectorAll('.js-open-slide-course-popup-link');
  var coursePopupSwiper = document.querySelector('.js-popup__ccs');
  var courseSwiper = null;
  loadMoreBtn && loadMoreBtn.addEventListener('click', function () {
    loadMoreBtn && loadMoreBtn.classList.add('hide');
    mirrorItem && mirrorItem.forEach(function (item) {
      var el = item;
      el.classList.remove('hide');
    });
  });
  if (coursePopupSwiper) {
    courseSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](coursePopupSwiper, {
      slidesPerView: 1,
      spaceBetween: 0,
      navigation: {
  ...
  openCoursesSliderLinks && coursePopupSwiper && _toConsumableArray(openCoursesSliderLinks).forEach(function (item) {
...
/******/ })()
;
//# sourceMappingURL=js-block-mirror-repeater.js.map