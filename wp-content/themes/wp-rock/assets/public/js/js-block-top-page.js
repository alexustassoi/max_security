...
;// CONCATENATED MODULE: ./src/js/components/popup-warning.ts
...
/* harmony default export */ var popup_warning = (popupWarningTrigger);
;// CONCATENATED MODULE: ./src/js/acf-blocks/block-top-page.ts
var _a, _b;
...
var initBlockExample = function initBlockExample() {
  ...
  var topPageSwiper = document.querySelector('.js-top-page-swiper');
  var topPageTitles = document.querySelector('.js-top-page-titles');
  ...
  if (topPageTitles) {
    var swiperTitles = new core(topPageTitles, {
      slidesPerView: 1,
      loop: true,
      direction: 'vertical',
      modules: [Autoplay],
  ...
  document.body.addEventListener('click', function (e) {
    ...
    switch (role) {
      ...
      case 'load-content-demo-popup':
        {
          e.preventDefault();
          var _targetPopup = window.document.getElementById('#popup-request-demo');
          if (!popupInstance && !_targetPopup) return;
          popup_warning(target);
          break;
        }
      default:
