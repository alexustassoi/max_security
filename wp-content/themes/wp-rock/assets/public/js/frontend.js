...
__webpack_require__.d(__webpack_exports__, {
  A: function() { return /* binding */ block_blog_read_more; }
});
...
;// CONCATENATED MODULE: ./src/js/acf-blocks/block-blog-read-more.ts
...
var initBlockBlogReadMore = function initBlockBlogReadMore() {
  ...
  if (blogReadMoreSwiper) {
    var blogReadMoreSlider = new core(blogReadMoreSwiper, {
      spaceBetween: 42,
      slidesPerView: 3,
      loop: true,
      freeMode: true,
...
/* harmony default export */ var block_blog_read_more = (initBlockBlogReadMore);
...
// EXTERNAL MODULE: ./src/js/acf-blocks/block-blog-read-more.ts + 90 modules
var block_blog_read_more = __webpack_require__(6623);
...
function ready() {
  ...
  checkScrollPosition();
  (0,block_blog_read_more/* default */.A)();
