...
/*!********************************************!*\
  !*** ./src/js/acf-blocks/block-experts.ts ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
var initBlockExperts = function initBlockExperts() {
  var expertsSwiper = document.querySelector('.js-experts-slider');
  if (expertsSwiper) {
    var expertsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](expertsSwiper, {
      loop: true,
      navigation: {
...
if (window['acf']) {
  (_a = window['acf']) === null || _a === void 0 ? void 0 : _a.addAction('render_block_preview', initBlockExperts);
}
/******/ })()
;
//# sourceMappingURL=js-block-experts.js.map