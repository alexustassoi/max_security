...
/*!*************************************************!*\
  !*** ./src/js/acf-blocks/block-slider-popup.ts ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
var initBlockSliderPopup = function initBlockSliderPopup() {
  ...
  if (sliderPopupSwiper1) {
    ...
    if (checkTabletAndUpper.matches) {
      var sliderPopupBlock = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderPopupSwiper1, {
        slidesPerView: 1,
        spaceBetween: 20,
        breakpoints: {
          991: {
  ...
  if (sliderPopupSwiper2) {
    ...
    var sliderPopup = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderPopupSwiper2, {
      slidesPerView: 1,
      autoHeight: true,
      navigation: {
    ...
    sliderPopupsBtn && sliderPopupsBtn.forEach(function (btn) {
      btn.addEventListener('click', function () {
        var btnElem = btn;
        if (btnElem === null || btnElem === void 0 ? void 0 : btnElem.dataset.slideIndex) {
          var index = parseInt(btnElem.dataset.slideIndex, 10);
...
if (window['acf']) {
  (_a = window['acf']) === null || _a === void 0 ? void 0 : _a.addAction('render_block_preview', initBlockSliderPopup);
}
/******/ })()
;
//# sourceMappingURL=js-block-slider-popup.js.map